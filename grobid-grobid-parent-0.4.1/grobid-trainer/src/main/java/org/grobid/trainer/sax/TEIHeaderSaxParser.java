...
public class TEIHeaderSaxParser extends DefaultHandler {
    ...
    public String getArticleNote() { return articlenote; }

    public String getAuthorBiography() { return authorbiography; }
    ...
    public void endElement(java.lang.String uri,
        ...
        if (qName.equals("articlenote")) {
            articlenote = getText();
        }

        if (qName.equals("acknowledgement")) {
            articlenote = getText();
        }

        if (qName.equals("authorbiography")) {
            authorbiography = getText();
        }
        ...
        if ((qName.equals("titlePart")) | (qName.equals("note")) | (qName.equals("docAuthor")) |
                ...
                (qName.equals("intro")) | (qName.equals("articlenote")) | (qName.equals("acknowledgement")) |
                (qName.equals("phone")) | (qName.equals("authorbiography"))
                ) {
            String text = getText();
            // we segment the text
    ...
    public void startElement(String namespaceURI,
        ...
        if (qName.equals("div")) {
            ...
            currentTag = "<phone>";
        } else if (qName.equals("articlenote")) {
            currentTag = "<articlenote>";
        } else if (qName.equals("acknowledgement")) {
            currentTag = "<acknowledgement>";
        } else if (qName.equals("authorbiography")) {
            currentTag = "<authorbiography>";
