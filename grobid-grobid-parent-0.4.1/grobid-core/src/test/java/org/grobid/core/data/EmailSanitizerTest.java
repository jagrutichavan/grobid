...
public class EmailSanitizerTest {
    ...
    @Test
    public void test_get_staff_containg_email(){
        //...Arrange
        List<String> inputAddresses = new ArrayList<>();
        inputAddresses.add("ekokinou@staff.teicrete.gr");

        List<String> expectedAddressesList = new ArrayList<>();
        expectedAddressesList.add("ekokinou@staff.teicrete.gr");
        Object[] expectedAddresses = expectedAddressesList.toArray();

        //...Act
        Object[] actualdAddresses = sanitizer.splitAndClean(inputAddresses).toArray();

        //...Assert
        assertArrayEquals("staff containg email is block", expectedAddresses, actualdAddresses);
