...
//	public String fileName = null;
    ...
    public void createTrainingHeader(String inputFile, String pathHeader, String pathTEI, int id) {
        Document doc = parsers.getHeaderParser().createTrainingHeader2(inputFile, pathHeader, pathTEI);
    }


    /**
     * Consume by Rest Service.
     * @param inputFile
     */
    public CreateTrainingHeader createTrainingHeader(String inputFile) {
        return parsers.getHeaderParser().createTrainingHeader2(inputFile);
    }
