...
public class MockContext {
	...
	public static void setInitialContextLocally(String pGrobidHome) throws Exception {
		GROBID_HOME_PATH = pGrobidHome;
		GROBID_PROPERTY_PATH = GROBID_HOME_PATH + "/config/grobid.properties";
		GROBID_PROPERTY_SERVICE_PATH = GROBID_HOME_PATH + "/config/grobid_service.properties";
		setInitialContext();
	}
